<div class="space-y-6">
    ...
    <div>
        ...
        <x-text-input id="evaluado" name="evaluado" type="text" class="block w-full mt-1"
            :value="old('evaluado', $aspirante?->evaluado)" autocomplete="evaluado" placeholder="Evaluado" />
        <x-input-error class="mt-2" :messages="$errors->get('evaluado')" />
    </div>
    <div>
        <x-input-label for="puntaje" :value="__('Puntaje')" />
        <x-text-input id="puntaje" name="puntaje" type="text" class="block w-full mt-1"
    ...
    <div>
        ...
        <x-text-input id="fecha_evaluacion" name="fecha_evaluacion" type="text" class="block w-full mt-1"
            :value="old('fecha_evaluacion', $aspirante?->fecha_evaluacion)" autocomplete="fecha_evaluacion"
            placeholder="Fecha Evaluacion" />
        <x-input-error class="mt-2" :messages="$errors->get('fecha_evaluacion')" />
    </div>
    <div>
        <x-input-label for="fecha_seleccion" :value="__('Fecha Seleccion')" />
        <x-text-input id="fecha_seleccion" name="fecha_seleccion" type="text" class="block w-full mt-1"
            :value="old('fecha_seleccion', $aspirante?->fecha_seleccion)" autocomplete="fecha_seleccion"
            placeholder="Fecha Seleccion" />
    ...
    <div>
        ...
        <x-text-input id="fecha_acceso" name="fecha_acceso" type="text" class="block w-full mt-1"
            :value="old('fecha_acceso', $aspirante?->fecha_acceso)" autocomplete="fecha_acceso"
