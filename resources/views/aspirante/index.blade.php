          ...
          <div class="sm:flex sm:items-center">
            ...
            <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
              ...
              <a type="button" href="{{ route('aspirantes.upload') }}"
                class="block px-3 py-2 mt-2 text-sm font-semibold text-center text-white bg-gray-600 rounded-md shadow-sm hover:bg-gray-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-600">Subir
                aspirantes</a>
            </div>
          </div>
